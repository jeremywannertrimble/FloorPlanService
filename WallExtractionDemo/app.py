...
from utils.utils import (create_patches, 
                  generate_patches_masks, merging_patches, visualize_mask, pdf_to_img)
...
with title_col1:
    st.image("logo/atlas-logo-black.png", width=100)  # Adjust width as needed

with title_col2:
    st.title("Floor Plan Wall Extraction")
